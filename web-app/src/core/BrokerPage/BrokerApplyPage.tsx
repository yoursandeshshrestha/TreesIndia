...
const steps = [
  ...
  },
  {
    ...
    icon: Building,
    description: "License and agency",
  },
  {
    id: 4,
    title: "Review & Submit",
...
export default function BrokerApplyPage() {
  ...
  const handleSubmit = () => {
    if (validateStep(activeStep)) {
      const completeFormData: BrokerApplicationRequest = {
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">
              {userApplication.status === "approved"
                ...
                : "Your broker application has been submitted successfully. We'll review your application and get back to you soon."}
            </p>
