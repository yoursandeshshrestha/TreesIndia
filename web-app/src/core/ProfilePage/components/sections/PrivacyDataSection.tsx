        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-blue-800 leading-relaxed">
              We're committed to protecting your privacy. Your data is encrypted
              and we never share your personal information without your explicit
              consent. You have full control over your data and can modify these
