...
export default function PopularServices() {
  ...
  const handleServiceClick = (service: PopularService) => {
    // Handle service card click - you can add navigation or modal logic here
  ...
  if (isLoading || locationLoading) {
    return (
      <section className="py-20 px-6 max-w-7xl mx-auto">
        ...
        <h2 className="text-3xl font-medium text-gray-900 leading-tight mb-4">
          {locationLoading
        ...
        <p className="text-gray-500">
          {locationLoading
            ? "Please wait while we detect your location to show relevant services..."
  ...
  if (isError && error) {
    return (
      <section className="py-20 px-6 max-w-7xl mx-auto">
        ...
        <p className="text-red-600">Failed to load popular services</p>
      </section>
    );
  }
