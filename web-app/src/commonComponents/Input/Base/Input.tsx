...
const CustomInput = forwardRef<HTMLInputElement, CustomInputProps>(
  (
    ...
    const baseInputClasses =
      "px-3 sm:px-4 py-2 sm:py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-300 focus:border-transparent outline-none transition-all text-sm sm:text-base";
