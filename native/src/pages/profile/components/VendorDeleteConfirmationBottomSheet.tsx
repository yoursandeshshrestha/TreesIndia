...
interface VendorDeleteConfirmationBottomSheetProps {
  visible: boolean;
  onClose: () => void;
  onConfirm: () => void;
  vendorName: string;
...
export default function VendorDeleteConfirmationBottomSheet({
  visible,
  onClose,
  onConfirm,
  vendorName,
  isDeleting = false,
}: VendorDeleteConfirmationBottomSheetProps) {
          ...
          <SafeAreaView edges={['bottom']} className="rounded-t-3xl bg-white">
            <View className="px-6 py-6">
              ...
              <Text
                ...
                Are you sure you want to delete &quot;{vendorName}&quot;? This action cannot be
                undone.
              </Text>
