                  ...
                  {[
                    ...
                    service.price_type
                      ? {
                          label: 'Pricing Type',
                          value:
                            service.price_type === 'fixed' ? 'Fixed Price' : 'Contact for Pricing',
                          icon: null,
                        }
                      : null,
                    service.duration
                    ...
                    .map((detail, index, array) => (
                      <View
                        key={index}
                        className={`${index < array.length - 1 ? 'mb-3 border-b border-[#E5E7EB] pb-3' : ''}`}>
            ...
            <SafeAreaView edges={['bottom']} className="border-t border-[#E5E7EB] bg-white">
              <View className="px-6 pb-9 pt-4">
                <TouchableOpacity
                  ...
                  className="flex-row items-center justify-center rounded-xl bg-[#00a871] py-4"
                  activeOpacity={0.7}
                  disabled={isClosing}>
                  <Text
