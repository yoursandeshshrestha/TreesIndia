  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <Path
        ...
        strokeLinecap="round"
      />
      <Path d="M3 6H6M3 10H6M3 14H6" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
      <Path d="M15 13H17M15 16H17" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
      <Path d="M16 22L16 19" stroke={color} strokeWidth="1.5" strokeLinecap="round" />
    </Svg>
  );
}
