...
class BrokerApplicationStatusWidget extends StatelessWidget {
  final BrokerApplicationEntity application;

  const BrokerApplicationStatusWidget({
    super.key,
  ...
  String _getStatusMessage(ApplicationStatus status) {
    switch (status) {
      case ApplicationStatus.approved:
        return 'Your broker application has been approved!';
      case ApplicationStatus.pending:
