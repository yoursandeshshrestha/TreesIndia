...
class InquiryStepIndicatorWidget extends StatelessWidget {
  final int currentStep;

  const InquiryStepIndicatorWidget({
    super.key,
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          Row(
            children: [
              _buildStepIndicator(0, 'Details', currentStep >= 0),
              Expanded(child: Container()),
              _buildStepIndicator(1, 'Review', currentStep >= 1),
            ],
          ),
        ],
      ),
